...
/**
 * Live model ranking. Rows appear as models finish training; classification
 * ranks by accuracy (higher wins), regression by RMSE (lower wins), each with
 * the delta against the naive baseline made explicit.
 */
